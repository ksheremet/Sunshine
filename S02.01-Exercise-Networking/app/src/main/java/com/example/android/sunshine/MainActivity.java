...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(final String preferableLocation) {
        new FetchWeatherAsyncTask().execute(NetworkUtils.buildUrl(preferableLocation));
    }
    ...
    private class FetchWeatherAsyncTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try {
                ...
                simpleJsonData =
                        OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,
                                weatherResult);
            } catch (IOException e) {
                e.printStackTrace();
