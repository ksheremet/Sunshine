...
//      Completed (7) Display the weather icon using mDetailBinding
        mDetailBinding.weatherInfo.weatherIcon
                .setImageResource(SunshineWeatherUtils
                        .getLargeArtResourceIdForWeatherCondition(data
                                .getInt(INDEX_WEATHER_CONDITION_ID)));
...
//      Completed (8) Use mDetailBinding to display the date
        mDetailBinding.weatherInfo.date.setText(dateText);
...
//      Completed (15) Create the content description for the description for a11y
        mDetailBinding.weatherInfo.weatherDescription.setContentDescription("Weather is "+ description);
...
//      Completed (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.weatherInfo.weatherDescription.setText(description);

//      Completed (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.weatherInfo.weatherIcon.setContentDescription(description);
...
//      Completed (17) Create the content description for the high temperature for a11y
        mDetailBinding.weatherInfo.highTemperature
                .setContentDescription("High Temperature is" + highString);
...
//      Completed (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.weatherInfo.highTemperature.setText(highString);
...
//      Completed (18) Create the content description for the low temperature for a11y
        String lowTemperatureDescription  = " Low temperature for " + dateText + " is "+ lowString;
...
//      Completed (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.weatherInfo.lowTemperature.setText(lowString);
        mDetailBinding.weatherInfo.lowTemperature.setContentDescription(lowTemperatureDescription);
...
//      Completed (20) Create the content description for the humidity for a11y
        String humidityDescription = "Humidity for "+ dateText + " is " + humidityString;
...
//      Completed (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeatherDetails.humidity.setContentDescription(humidityDescription);

//      Completed (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetails.tvHumidityLabel.setContentDescription(humidityDescription);
...
//      Completed (21) Create the content description for the wind for a11y
        String windDescription = "Wind for "+ dateText + " is" + windString;
...
//      Completed (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetails.wind.setContentDescription(windDescription);

//      Completed (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetails.tvWindLabel.setContentDescription(windDescription);
...
//      Completed (23) Create the content description for the pressure for a11y
        String pressureDescription = "Pressure for " + dateText + " is " + pressureString;
...
//      Completed (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetails.pressure
                .setContentDescription(pressureDescription);

//      Completed (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetails.tvPressureLabel.setContentDescription(pressureDescription);
