...
//  Completed (10) Remove the mWeatherDisplay TextView declaration
    ...
    private TextView mHighTemperatureTV;
    private TextView mLowTemperatureTV;
...
//      Completed (13) Find each of the TextViews by ID
        mDateTV = (TextView) findViewById(R.id.weather_date);
        mDescriptionTV = (TextView) findViewById(R.id.weather_description);
        mHighTemperatureTV = (TextView) findViewById(R.id.weather_high_temperature);
        mHumidityTV = (TextView) findViewById(R.id.weather_humidity);
        mLowTemperatureTV = (TextView) findViewById(R.id.weather_low_temperature);
        mPressureTV = (TextView) findViewById(R.id.weather_pressure);
        mWindTV = (TextView) findViewById(R.id.weather_wind);
        ...
        switch (id) {
            case LOADER_ID:
                return new CursorLoader(this,
                        ...
                        null,
                        null);
            default: throw new UnsupportedOperationException("Uri not implemented:" + mUri);
        }
    }
...
//      COMPLETED (28) Display the high temperature
        ...
        /* Set the text */
        mHighTemperatureTV.setText(highString);
...
//      COMPLETED (29) Display the low temperature
        ...
        /* Set the text */
        mLowTemperatureTV.setText(lowString);
...
//      COMPLETED (32) Display the pressure
        ...
        /* Set the text */
        mPressureTV.setText(pressureString);
